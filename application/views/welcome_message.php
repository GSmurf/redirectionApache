...
<head>
		...
		<title>Tests de redictions Apache</title>
...
<body>
	...
	<header id="header" role="banner" class="line pam">
		...
		<aside class="mod left w20 mrs pam aside">
			...
			<p>Lorem Salu bissame ! Wie geht's les samis ? Une Carola et du Melfor ? Yo dû, espèce de Knäckes, ch'ai dit un picon !</p>
		</aside>
		...
		<div id="main" role="main" class="mod pam">
			...
			<p class="">Lorem Salu bissame ! Wie geht's les samis ? Hans apporte moi une Wurschtsalad avec un picon bitte, s'il te plaît.
			  Voss ? Une Carola et du Melfor ? Yo dû, espèce de Knäckes, ch'ai dit un picon !</p> 
		</div>
